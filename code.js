(() => {
  ...
  function resolveScope(scopeId) {
    return __async(this, null, function* () {
      ...
      const node = yield figma.getNodeByIdAsync(scopeId);
      if (!node)
  ...
  var readHandlers = {
    ...
    get_node(params) {
      return __async(this, null, function* () {
        const node = yield requireNode(params.nodeId);
    ...
    get_all_texts(params) {
      return __async(this, null, function* () {
        var _a;
        const scopeNode = params.scopeId ? yield figma.getNodeByIdAsync(params.scopeId) : (_a = figma.currentPage.selection[0]) != null ? _a : figma.currentPage;
        if (!scopeNode)
    ...
    get_annotations(params) {
      return __async(this, null, function* () {
        var _a, _b;
        const node = (_b = yield figma.getNodeByIdAsync((_a = params.nodeId) != null ? _a : null)) != null ? _b : figma.currentPage;
    ...
    find_all_instances(params) {
      return __async(this, null, function* () {
        const scopeNode = yield resolveScope(params.scopeId);
  ...
  var createHandlers = {
    ...
    create_text(params) {
      return __async(this, null, function* () {
        ...
        yield figma.loadFontAsync({ family: (_b = params.fontFamily) != null ? _b : "Inter", style: (_c = params.fontStyle) != null ? _c : "Regular" });
  ...
  var componentsHandlers = {
    ...
    add_component_property(params) {
      return __async(this, null, function* () {
        var _a;
        const node = yield requireNode(params.componentId);
    ...
    get_component_properties(params) {
      return __async(this, null, function* () {
        const node = yield requireNode(params.nodeId);
    ...
    create_component_from_node(params) {
      return __async(this, null, function* () {
        const node = yield requireNode(params.nodeId);
    ...
    get_instance_properties(params) {
      return __async(this, null, function* () {
        var _a, _b, _c, _d, _e;
        const node = yield requireNode(params.nodeId);
        if (node.type !== "INSTANCE")
  ...
  var auditHandlers = {
    ...
    audit_missing_components(params) {
      return __async(this, null, function* () {
        const scopeNode = yield resolveScope(params.scopeId);
    ...
    audit_all(params, dispatch2) {
      return __async(this, null, function* () {
        var _a;
        const scopeId = (_a = params.scopeId) != null ? _a : null;
        const run = (action) => __async(this, null, function* () {
          try {
            return yield dispatch2(action, { scopeId });
          } catch (e) {
  ...
  var structureHandlers = {
    ...
    batch(params, dispatch2) {
      return __async(this, null, function* () {
        const results = [];
        for (const sub of params.commands) {
          try {
            results.push(yield dispatch2(sub.action, sub));
          } catch (e) {
  ...
  figma.ui.onmessage = (msg) => __async(void 0, null, function* () {
    ...
    let result;
    try {
      result = yield dispatch(action, params);
    } catch (e) {
